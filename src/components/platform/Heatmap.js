            ...
            <div class="hidden lg:block">
                ...
                <div class="flex mt-4">
                    <select
                        ...
                        class="block py-1 px-0 w-1/6 text-sm bg-transparent border-0 border-b-2 text-gray-400 border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                    >
                    ...
                    <select
                        ...
                        class="ml-4 block py-1 px-0 w-1/6 text-sm bg-transparent border-0 border-b-2 text-gray-400 border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                    >
                ...
                <div class="mt-3 flex flex-col gap-1.5">
                    {days.map((day, dayIndex) => (
                        <div class="flex gap-1.5">
                            <span class="mr-2 text-xl font-light text-gray-200">
                                {day}
                            </span>
                            {heatmapType === "조회수"
                                ? Object.entries(
                ...
                {Object.entries(heatmapData[heatmapGenre].bestTimes).map(
                    ([key, value]) => (
                        <div class="w-fit p-2 mr-3 rounded-md bg-white bg-opacity-5">
                            <span class="text-xl font-light text-gray-200">
                                {value}
                            </span>
                        </div>
                    )
